...
public class ReconCard {
	...
	public ReconCard(Context c, String image, int id, int left, int right, int up, int down, int select, int selectHold, int back, int nextCard, int nextCardDelay, String nextCardAnimation, int nextCardAnimationDuration) {
		this.leftCard = left;
